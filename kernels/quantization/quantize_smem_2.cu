...
__global__ void find_abs_max_kernel_optimized(const half* input, float* max_val, int N) {
...
int main() {
    ...
    find_abs_max_kernel_optimized<<<num_blocks, block_size>>>(d_input, d_max_val, N);
